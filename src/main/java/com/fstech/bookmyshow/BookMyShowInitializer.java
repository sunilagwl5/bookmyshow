...
import com.fstech.bookmyshow.Controller.MovieController;
import com.fstech.bookmyshow.Controller.TheatreController;
...
public class BookMyShowInitializer {
    ...
    public BookMyShowInitializer() {
        movieController = new MovieController();
        theatreController = new TheatreController();
    }

    public void start() {
        BookMyShowInitializer bookMyShow = new BookMyShowInitializer();
